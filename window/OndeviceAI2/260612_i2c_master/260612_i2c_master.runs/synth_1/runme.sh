...
HD_PWD='C:/Working/OndeviceAI2/260612_i2c_master/260612_i2c_master.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_master_stopwatch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_master_stopwatch.tcl
