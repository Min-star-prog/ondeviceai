...
HD_PWD='C:/Working/OndeviceAI2/260612_i2c_master/260612_i2c_master.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_master_stopwatch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_master_stopwatch.tcl -notrace
