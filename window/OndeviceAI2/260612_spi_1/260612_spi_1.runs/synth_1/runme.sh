...
HD_PWD='C:/Working/OndeviceAI2/260612_spi_1/260612_spi_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_master_stopwatch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_master_stopwatch.tcl
