...
HD_PWD='C:/Working/OndeviceAI2/260612_spi_1/260612_spi_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_master_stopwatch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_master_stopwatch.tcl -notrace
