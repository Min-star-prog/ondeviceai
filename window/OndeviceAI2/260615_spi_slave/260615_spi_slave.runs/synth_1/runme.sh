...
HD_PWD='C:/Working/OndeviceAI2/260615_spi_slave/260615_spi_slave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_slave_stopwatch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_slave_stopwatch.tcl
