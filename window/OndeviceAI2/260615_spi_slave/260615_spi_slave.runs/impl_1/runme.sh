...
HD_PWD='C:/Working/OndeviceAI2/260615_spi_slave/260615_spi_slave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_slave_stopwatch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_slave_stopwatch.tcl -notrace
