...
HD_PWD='C:/Working/OndeviceAI2/20260519_RV32I/20260519_RV32I.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rv32i_soc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_rv32i_soc.tcl -notrace
