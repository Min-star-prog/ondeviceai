...
HD_PWD='C:/Working/OndeviceAI2/fifo_sensor/fifo_sensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_4module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_4module.tcl -notrace
