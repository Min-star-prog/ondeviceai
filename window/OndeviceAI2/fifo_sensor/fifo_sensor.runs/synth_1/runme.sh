...
HD_PWD='C:/Working/OndeviceAI2/fifo_sensor/fifo_sensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_4module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_4module.tcl
