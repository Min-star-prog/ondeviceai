...
HD_PWD='C:/Working/OndeviceAI2/260615_i2c_slave_1/260615_i2c_slave_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_slave_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_slave_top.tcl -notrace
