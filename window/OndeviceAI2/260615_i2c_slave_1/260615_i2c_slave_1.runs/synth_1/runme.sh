...
HD_PWD='C:/Working/OndeviceAI2/260615_i2c_slave_1/260615_i2c_slave_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_slave_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_slave_top.tcl
