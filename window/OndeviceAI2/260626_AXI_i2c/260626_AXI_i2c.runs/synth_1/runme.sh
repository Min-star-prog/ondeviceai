...
HD_PWD='C:/Working/OndeviceAI2/260626_AXI_i2c/260626_AXI_i2c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_i2c_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_i2c_top.tcl
