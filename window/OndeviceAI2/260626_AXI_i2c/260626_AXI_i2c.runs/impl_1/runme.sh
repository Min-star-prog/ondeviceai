...
HD_PWD='C:/Working/OndeviceAI2/260626_AXI_i2c/260626_AXI_i2c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_i2c_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_i2c_top.tcl -notrace
